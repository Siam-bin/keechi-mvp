...
export default function LoginShopPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await loginShop(formData.email, formData.password);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-charcoal-50 to-white">
      <div className="max-w-md mx-auto px-4 py-20">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-charcoal-900 mb-2">Shop Owner Login</h1>
          <p className="text-charcoal-600">Access your shop dashboard and manage appointments.</p>
        </div>
        ...
        <p className="text-center text-charcoal-600 mt-6">
          ...
          <Link href="/signup-shop" className="text-gold-500 font-semibold hover:text-gold-600">
            Register your shop
          </Link>
        </p>
        ...
        <div className="mt-8 p-4 bg-emerald-50 rounded-lg border border-emerald-200">
          <p className="text-sm text-charcoal-700">
            ...
            <Link href="/login-user" className="text-emerald-600 font-semibold hover:text-emerald-700">
              Customer login
            </Link>
          </p>
        </div>
